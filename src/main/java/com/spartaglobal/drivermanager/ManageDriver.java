package com.spartaglobal.drivermanager;
...
public class ManageDriver {
    ...
    private static final Logger log = LogManager.getLogger(ManageDriver.class.getName());// to generate the log file

    public static WebDriver driver;
    public String baseUrl = PropertyReader.getInstance().getProperty("baseUrl");//from config file
